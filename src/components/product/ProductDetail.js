...
class ProductDetail extends Component {
  ...
  render() {
    ...
    let classContainer = ( isLoading ) ? 'ss-container-loading': '';
    let classDetail = ( isLoading ) ? 'ss-hide ss-product__box ss-product__detail': 'ss-block ss-product__box ss-product__detail';
    return (
